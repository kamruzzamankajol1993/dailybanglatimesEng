                ...
                <div class="col-lg-4 col-md-6 order-3 order-lg-3 d-flex flex-column">
                    <div class="bg-white border p-0 mb-4 shadow-sm flex-grow-1 d-flex flex-column">
                        <ul class="nav nav-pills nav-fill" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <button class="nav-link active rounded-0 fw-bold py-2 custom-tab-btn tab-green" id="latest-tab" data-bs-toggle="pill" data-bs-target="#latest">Latest</button>
                            </li>
                            <li class="nav-item">
                                <button class="nav-link rounded-0 fw-bold py-2 custom-tab-btn tab-red" id="popular-tab" data-bs-toggle="pill" data-bs-target="#popular">Popular</button>
                            </li>
                        </ul>
