...
//                     $language = (isset($apiPost['public_site']) && $apiPost['public_site'] == 1) ? 'en' : 'en';
...
public function archive(Request $request)
{
    ...
    $calendarData = [
        ...
        'banglaMonth' => $currentDate->locale('en')->isoFormat('MMMM YYYY'), // For Display
